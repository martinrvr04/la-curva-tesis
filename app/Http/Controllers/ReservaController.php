...
class ReservaController extends Controller
{
        ...
        try {
            ...
            if ($check_in && $check_out) {
                ...
                $habitaciones = Habitacion::query()
                    ...
                    ->disponibles($check_in, $check_out)
            ...
            return response()->json([
                'message' => app()->environment('local') ? $e->getMessage() : 'Error interno.'
            ], 500);
        }
    }

    /**
     * Paso 2: Crear pre-reserva
     */
    public function store(Request $request)
    {
        ...
        return DB::transaction(function () use ($request, $data) {
            ...
            $reserva = new Reserva([
                ...
                'numero_adultos' => (int) $data['huespedes'],
                'numero_ninos'   => 0,
                'estado'         => 'pre_reserva',
                'origen'         => 'web',
                'total_reserva'  => round($noches * (float)$habitacion->precio_noche, 2),
                'payment_status' => 'unpaid',
                'expires_at'     => now()->addSeconds(15), // ⏳ bloquea solo 15 min
            ]);
    ...
    /**
     * Paso 3: Resumen de reserva (antes de pagar o confirmada)
     */
